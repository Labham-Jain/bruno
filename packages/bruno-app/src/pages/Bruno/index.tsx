...
export default function Main() {
  const activeTabUid = useAppSelector((state) => state.tabs.activeTabUid);
  const isDragging = useAppSelector((state) => state.app.isDragging);
  const showHomePage = useAppSelector((state) => state.app.showHomePage);
